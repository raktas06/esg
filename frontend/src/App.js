        ...
        {!selectedOrg ? (
          ...
          <Tabs value={currentView} onValueChange={setCurrentView}>
            ...
            <TabsContent value="assessment" className="space-y-6">
              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-2">ESG Canvas Değerlendirmesi</h2>
                <p className="text-gray-600 max-w-2xl mx-auto">
                  Business Model Canvas yaklaşımı ile sürdürülebilirlik stratejinizi değerlendirin
                </p>
              </div>
