...
@api_router.get("/")
async def root():
    return {"message": "ESG Reporting API v2.0 - Enhanced"}
...
async def initialize_comprehensive_sample_data():
    ...
    return {
        "message": f"Initialized {len(comprehensive_questions)} comprehensive questions across all canvas sections and {len(sample_orgs)} sample organizations",
